...
xlabel('x');ylabel('y');
title({['Lab 7.2 Ramdon Search 11612001 黄松'],['Opt point:',num2str(xy_best')],['Auckley Opt value:',num2str(f_opt)]});
...
plot(t,step_opt,'');
grid on
title({['Lab 7.2 Ramdon Search 11612001 黄松'],['Opt point:',num2str([xy(1,ind) xy(2,ind)])],['Auckley Opt value:',num2str(min(f_opt))]});
